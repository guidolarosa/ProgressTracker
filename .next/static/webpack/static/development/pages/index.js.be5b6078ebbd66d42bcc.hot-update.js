  ...
  var isDayEmpty = function isDayEmpty(year, month, day) {
    ...
    if (userTaskHistory) {
      userTaskHistory.forEach(function (task) {
        var taskDate = new Date(task.date); // console.log(givenDate);
...
//# sourceMappingURL=index.js.be5b6078ebbd66d42bcc.hot-update.js.map