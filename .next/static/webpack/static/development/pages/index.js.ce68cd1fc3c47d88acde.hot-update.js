  ...
  var isDayEmpty = function isDayEmpty(year, month, day) {
    ...
    if (userTaskHistory) {
      userTaskHistory.forEach(function (task) {
        var taskDate = new Date(task.date); // console.log('Given date: ' + givenDate.getTime());
...
//# sourceMappingURL=index.js.ce68cd1fc3c47d88acde.hot-update.js.map