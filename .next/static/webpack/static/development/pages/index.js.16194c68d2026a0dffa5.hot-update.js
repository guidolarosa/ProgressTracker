  ...
  var isDayEmpty = function isDayEmpty(year, month, day) {
    ...
    if (userTaskHistory) {
      userTaskHistory.forEach(function (task) {
        ...
        console.log('Given date: ' + givenDate.getTime());
        console.log('Task date: ' + taskDate.getTime());

        if (taskDate.getTime() == givenDate.getTime()) {// console.log(givenDate);
        }
      });
    }
  };
...
//# sourceMappingURL=index.js.16194c68d2026a0dffa5.hot-update.js.map